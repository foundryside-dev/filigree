...
def init(prefix: str | None, name: str | None, mode: str | None) -> None:
    ...
    if already_installed:
        ...
        except (StoreMigrationBusyError, StoreMigrationConfUnreadableError, StoreMigrationUnsafePathError) as exc:
            # Refused before any mutation — a live writer holds the DB, or the
            # configuration/destination is unsafe. The legacy layout is left
